...
pagination_template = get_template('admin/store/productreport/pagination.html')
register.inclusion_tag(pagination_template)(pagination)

result_list_template = get_template('admin/store/productreport/change_list_results.html')
